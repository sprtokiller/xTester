import{x as d,g as e,H as L,j as C,v as B,aA as N,aB as V,e as M,l as F,u as _,q as D,s as H,b1 as G,h as n,b4 as q,ad as T}from"./index-ecfabf3d.js";import{u as K}from"./use-compitable-95cdef1d.js";import{g as W}from"./get-slot-1efb97e5.js";function O(t,p="default",l=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const b=i[p];if(typeof b=="function")return b()}return l}const E="DESCRIPTION_ITEM_FLAG";function J(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[E]:!1}const Q=d([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
