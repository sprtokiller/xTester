import{g,j as l,x as u,u as f,e as b,l as y,ci as $,q as a,s as x,au as C,h as d,a7 as _}from"./index-ecfabf3d.js";const z=/^(\d|\.)+$/,m=/(\d|\.)+/;function R(e,{c:t=1,offset:r=0,attachPx:o=!0}={}){if(typeof e=="number"){const n=(e+r)*t;return n===0?"0":`${n}px`}else if(typeof e=="string")if(z.test(e)){const n=(Number(e)+r)*t;return o?n===0?"0":`${n}px`:`${n}`}else{const n=m.exec(e);return n?e.replace(m,String((Number(n[0])+r)*t)):e}return e}const N=g("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
