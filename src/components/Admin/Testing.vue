...
import { NDataTable, useMessage, NButton, NSpin, NTag } from 'naive-ui';
...
export default {
  components: {
    NDataTable, NButton, NSpin, NTag, RemoveRedEyeRound
  },
  setup() {
...
<template>
  <div class="container">
    <n-spin :show="loading" style="min-height: 200px;">
      <n-data-table :columns="columns" :data="tests" :bordered="false" />
    </n-spin>
  </div>
</template>
